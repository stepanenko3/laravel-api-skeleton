...
#[AsCommand(name: 'logic-containers:model')]
class ContainerModelMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'logic-containers:model';
     ...
     * @var string
     */
    protected $description = 'Create a new Eloquent model class in logic container';
    ...
    {
        if ($this->option('pivot')) {
            return $this->resolveStubPath($this->stubsPath . '/model.pivot.stub');
        }

        if ($this->option('morph-pivot')) {
            return $this->resolveStubPath($this->stubsPath . '/model.morph-pivot.stub');
        }

        return $this->resolveStubPath($this->stubsPath . '/model.stub');
    }
